...
@Component({
  selector: 'app-reimburstment-resolved',
  templateUrl: './reimburstment-resolved.component.html',
  styleUrls: ['./reimburstment-resolved.component.css']
})
export class ReimburstmentResolvedComponent implements OnInit {
  ...
  constructor(private reimburstService: ReimburstmentResolvedService,
